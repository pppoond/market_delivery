...
class StorePasswordScreen extends StatelessWidget {
  static const routeName = "/store-password-screen";
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        userInputField(
                                          ...
                                          obscureText: true,
                                          controller:
                                              storeData.passwordTextController,
                                        ),
                                      ],
                                    ),
                                  ),
              ...
              bottomNavigationBar: SafeArea(
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: TextButton(
                      onPressed: () async {
                        if (storeProvider.passwordTextController.text != '') {
                          CoolAlert.show(
                              context: context,
