...
class StoreOrderTodayScreen extends StatelessWidget {
  static const routeName = "/store-order-today-screen";
  ...
  Stream<http.Response> getRandomNumberFact({required String storeId}) async* {
    ...
    yield* Stream.periodic(Duration(seconds: 1), (_) {
      return http.get(Uri.parse(
          Api.orders + "?store_id=$storeId&order_date=$formattedDate"));
